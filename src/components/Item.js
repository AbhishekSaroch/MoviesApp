...
// }
  return (
    ...
    <div className=' flex flex-col justify-center items-center gap-y-2 '>
       ...
       <div className='h-[60px]  shadow-[0_3px_10px_rgb(0,0,0,0.2)] w-full text-center rounded-lg py-1 overflow-hidden'>
       <h1 className='text-black text-xl font-semibold'>{movie.title.split(",",1)}</h1>
       </div>

       {/* <div className='h-[250px] overflow-hidden shadow-[0_3px_10px_rgb(0,0,0,0.2)] w-full text-center rounded-lg py-5'>

       <h1 className='text-black text-sm '>{movie.overview}<span className="read-more" onClick={readmoreHandler}>{readmore ? `Show Less`: `Read More`}</span></h1>
